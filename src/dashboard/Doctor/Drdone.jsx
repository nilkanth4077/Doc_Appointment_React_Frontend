                                        ...
                                        <div className="card">
                                            <div className="card-header p-3 pt-2">
                                                ...
                                                <div className="text-end pt-1">
                                                    <p className="text-sm mb-0 text-capitalize">Done Appointment</p>
                                        ...
                                        <div className="card my-4">
                                            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                                <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                                    <h6 className="text-white text-capitalize ps-3">My Done requestes</h6>
                                                </div>
                                            </div>
                                                                ...
                                                                doctor.map(doctor => (
                                                                    <>
                                                                        <tr >
                                                                            ...
                                                                            {/* <td className="align-middle text-center text-sm">
                                                                                <button className="btn badge badge-sm btn-success" value={doctor.email} type="button" >✔</button>
                                                                            </td>
                                                                            <td className="align-middle text-center text-sm">
