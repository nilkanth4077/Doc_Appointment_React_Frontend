...
function Displaypatient() {
    ...
    const fetchpatient = async () => {
        const res = await axios.get("https://doc-appointment-node-backend.onrender.com/patient/get");
                        ...
                        <div className="card my-4">
                                    ...
                                    <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                        <div className="card">
                                            <div className="card-header p-3 pt-2">
                                                ...
                                                <div className="text-end pt-1">
                                                    <p className="text-sm mb-0 text-capitalize">Register Patients</p>
                                                    <h4 className="mb-0">{patientlist.length}</h4>
                                                </div>
                                            </div>
                                            <hr className="dark horizontal my-0" />
                                            <div className="card-footer p-3">
                            ...
                            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 className="text-white text-capitalize ps-3">Patientlist</h6>
                                </div>
                            </div>
                                                ...
                                                patientlist.map(doc => (
                                                    <>
                                                        <tr >
                                                            ...
                                                            <td>
                                                                <p className="text-xs font-weight-bold mb-0">{doc.phonenumber}</p>
